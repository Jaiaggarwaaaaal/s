...
import { ClientOptions } from 'eniac';
...
export { ClientOptions } from 'eniac';
...
export function initMcpServer(params: {
  ...
  const client = new Eniac(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Eniac({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
